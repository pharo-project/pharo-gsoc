...
<ul>
  <li>Check the <a href="https://gsoc.pharo.org/ideas">list of project ideas</a>. Select one or two projects that you find interesting and think you have the right set of skills. Don’t be afraid to apply to projects where you only meet 51% of the listed requirements. Include a section on how you’ll compensate for or learn the missing skills — and demonstrate during the application process that you are working on acquiring those new skills.</li>
  <li>Join the Pharo Discord channel (follow the <a href="https://pharo.org/community">instructions</a>), go to the #gsoc-students channel and introduce yourself. Write who you are, where you come from, your interests, and which projects you would like to work on. Talk to other students, ask them questions, and get to know them. If you have trouble joining Discord, feel free to send a letter to any of the program organizers whose email addresses are listed at the bottom of this page.</li>
  <li>Get in touch with the mentors assigned to the projects you are interested in by email or Discord. You can find the email addresses of all our mentors in the <a href="https://gsoc.pharo.org/ideas">list of project ideas</a>. Talk to them about the complexity and skills required for the different projects.</li>
  <li>During the selection process, we will pay special attention to your experience with OOP and knowledge of Pharo. If you are new to Pharo, use the time you have before selection to enrich your portfolio. Read several chapters of <a href="https://books.pharo.org/updated-pharo-by-example/">Pharo by Example book</a> or take the <a href="https://mooc.pharo.org/">Pharo MOOC</a> - videos, exercises, challenges, and mini-projects. But most importantly, write something cool in Pharo and put it on your GitHub. It can be a simple project or exercise. If we see that you can write code and do it well, this will increase your chances of being accepted.</li>
...
export default CallForStudentsPage;
